...
> Canonicalized filename for local workflow parity.
>
> This file intentionally mirrors `docs/codex_full_rebuild_prompt_github.md` so rebuild instructions can reference a stable local path.
